...
3. Construct an entirely reproducible pipeline with industry-standard file structure, dependency control, configuration settings, and object-oriented structures.
